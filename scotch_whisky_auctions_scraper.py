...
def get_all_auctions():
    ...
    if response.status_code == 200:
        ...
        # Iterate through the elements and extract the "href" values
...
def get_auction_items(auction_urls):
        ...
        while(True):
            try:
                ...
                if response.status_code == 200:
                    ...
                    # Find and extract the desired information (e.g., item name)
                    ...
                    for element in elements:
                        ...
                        if href_value and href_value.startswith("auctions/"+auction_url):
                            ...
                            print("Successfully captured element: " + href_value)
                else:
...
def extract_item_details(item_url):
    ...
    if response.status_code == 200:
        ...
        # Example: Extracting item names and prices
        # Adjust the class names and tags according to your needs
        ...
        winning_bid = winning_bid_raw[len("Lot number:  £"):]
...
if __name__ == "__main__":
    # auction_urls = get_all_auctions()
    # auction_items = get_auction_items(auction_urls[0:2])

    output = extract_item_details("https://www.scotchwhiskyauctions.com/auctions/194-the-149th-auction/698686-aberlour-13-year-old-american-oak-cask-distillery-exclusive/")
